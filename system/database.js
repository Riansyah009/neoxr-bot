module.exports = (m) => {
   ...
   if (setting) {
      ...
      if (!('owners' in setting)) setting.owners = ['6282253969170']
      ...
      if (!('cover' in setting)) setting.cover = 'https://i.ibb.co/CPFLrs5/20230710-110121.jpg'
      if (!('link' in setting)) setting.link = 'https://chat.whatsapp.com/HkIAtlbjObD3OlrVj7RlVa'
   } else {
      global.db.setting = {
         autodownload: true,
         chatbot: true,
         ...
         multiprefix: true,
         prefix: ['.', '#', '!', '/'],
         toxic: ["ajg", "ajig", "anjas", "anjg", "anjim", "anjing", "anjrot", "anying", "asw", "autis", "babi", "bacod", "bacot", "bagong", "bajingan", "bangsad", "bangsat", "bastard", "bego", "bgsd", "biadab", "biadap", "bitch", "bngst", "bodoh", "bokep", "cocote", "coli", "colmek", "comli", "dajjal", "dancok", "dongo", "fuck", "gelay", "goblog", "goblok", "guoblog", "guoblok", "hairul", "henceut", "idiot", "itil", "jamet", "jancok", "jembut", "jingan", "kafir", "kanjut", "kanyut", "keparat", "kntl", "kontol", "lana", "loli", "lont", "lonte", "mancing", "meki", "memek", "ngentod", "ngentot", "ngewe", "ngocok", "ngtd", "njeng", "njing", "njinx", "oppai", "pantek", "pantek", "peler", "pepek", "pilat", "pler", "pornhub", "pucek", "puki", "pukimak", "redhub", "sange", "setan", "silit", "telaso", "tempek", "tete", "titit", "toket", "tolol", "tomlol", "tytyd", "iyan", "rian"],
         online: true,
         onlyprefix: '+',
         owners: ['6282253969170'],
         lastReset: new Date * 1,
         msg: 'Hi +tag 🪸\nI am an automated system (WhatsApp Bot) that can help to do something, search and get data / information only through WhatsApp.\n\n◦ *Database* : +db\n◦ *Library* : Baileys v+version\n◦ *Rest API* : https://api.neoxr.my.id\n◦ *Source* : https://github.com/neoxr/neoxr-bot\n\nIf you find an error or want to upgrade premium plan contact the owner.',
         menuStyle: 4,
         cover: 'https://i.ibb.co/CPFLrs5/20230710-110121.jpg',
         link: 'https://chat.whatsapp.com/HkIAtlbjObD3OlrVj7RlVa'
      }
   }
}